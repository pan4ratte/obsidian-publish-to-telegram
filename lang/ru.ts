...
3. Добавьте вашего бота в канал/группу и выдайте ему права на отправку сообщениий.`,
    ...
    SETTING_POST_START_MARKER_NAME: "Маркер начала поста",
    SETTING_POST_START_MARKER_DESC: "Текст, который обозначает начало содержимого, отправляемого в Telegram",
    SETTING_POST_START_MARKER_PLACEHOLDER: "Введите маркер начала (например, :::post-start-here)",
    SETTING_POST_END_MARKER_NAME: "Маркер конца поста",
    SETTING_POST_END_MARKER_DESC: "Текст, который обозначает конец содержимого, отправляемого в Telegram",
    SETTING_POST_END_MARKER_PLACEHOLDER: "Введите маркер конца (например, :::post-end-here)",
