export default {
    ...
    AUTH_ADD_BOT_TOKEN_BTN: "Добавить токен бота",
    ...
    BOT_TOKEN_INCOMPLETE: "Введите название и токен",
    ...
    CONFIRM_LOGOUT_MSG: "Вы уверены, что хотите выйти из «{name}»?",
    CONFIRM_LOGOUT_BTN: "Да, выйти",
    CONFIRM_CANCEL_BTN: "Отмена",
    CREDENTIALS_MODAL_TITLE: "Токены и аккаунт",
    CREDENTIALS_BOT_TOKENS_HEADING: "Токены ботов",
    CREDENTIALS_ACCOUNT_HEADING: "Аккаунт Telegram",
    CREDENTIALS_NO_TOKENS: "Сохранённых токенов пока нет.",
    CREDENTIALS_RENAME_TOKEN: "Переименовать",
    CREDENTIALS_DELETE_TOKEN_TITLE: "Удалить токен бота?",
    CREDENTIALS_DELETE_TOKEN_MSG: "Вы уверены, что хотите удалить «{name}»? Пресеты, использующие его, потеряют токен.",
    CREDENTIALS_DELETE_TOKEN_BTN: "Удалить",
