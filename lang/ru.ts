...
Ограничения rich-text сообщений: их нельзя редактировать и к ним нельзя прикреплять локальные файлы, можно делать только веб-встраивания. Оба ограничения установлены самим Telegram.`,
