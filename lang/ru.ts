export default {
    ...
    SETTING_METHOD_NAME: "Способ публикации по умолчанию",
    SETTING_METHOD_DESC: "Используется при публикации без выбора другого способа",
    ...
    SETTING_BOT_TOKEN_SELECT_NAME: "Токен бота",
    SETTING_BOT_TOKEN_SELECT_DESC: "Выберите сохранённый токен бота для этого пресета",
    ...
    SETTING_ACCOUNT_NAME: "Аккаунт",
    SETTING_ACCOUNT_DESC: "Выберите аккаунт Telegram, от имени которого публиковать",
    SETTING_ACCOUNT_PLACEHOLDER: "Выберите аккаунт…",
    SETTING_ACCOUNT_EMPTY_HINT: "Аккаунтов пока нет — добавьте через «Войти» выше",
