export default {
    ...
    AUTH_ADD_BOT_TOKEN_BTN: "Add bot token",
    ...
    BOT_TOKEN_INCOMPLETE: "Enter both a name and a token",
    ...
    CREDENTIALS_MODAL_TITLE: "Tokens and account",
    CREDENTIALS_BOT_TOKENS_HEADING: "Bot tokens",
    CREDENTIALS_ACCOUNT_HEADING: "Telegram account",
    CREDENTIALS_NO_TOKENS: "No bot tokens saved yet.",
    CREDENTIALS_RENAME_TOKEN: "Rename",
    CREDENTIALS_DELETE_TOKEN_TITLE: "Delete bot token?",
    CREDENTIALS_DELETE_TOKEN_MSG: "Are you sure you want to delete \"{name}\"? Presets using it will lose their token.",
    CREDENTIALS_DELETE_TOKEN_BTN: "Delete",
