...
Limitation of rich-text messages: you can't attach local files to them (web-embeds are supported). This limitation is imposed by Telegram.`,
    ...
    NOTICE_ERR_TOO_LONG_CAPTION: "Error: This publishing method supports posts with media attachments and text only less than 1025 symbols.",
    ...
    NOTICE_RICH_COMMENT_UNAVAILABLE: "Rich comment unavailable — sending as standard text. ({error})",
    NOTICE_COMMENT_DISCUSSION_NOT_FOUND: "Couldn't find the discussion message to comment under.",
    NOTICE_COMMENT_FAILED: "Comment failed: {error}",
    ERR_MEDIA_PREPARE_FAILED: "Failed to prepare media for sending",
    ERR_BOT_TOKEN_NOT_CONFIGURED: "Bot is not configured for this preset, choose a bot to post",
    ERR_NO_CHAT_TARGETS: "No chat targets configured for this preset.",
    AUTH_SUCCESS: "Successfully authorized",
    AUTH_ERROR: "Authorization error",
    MULTI_PRESET_NO_SELECTION: "Choose a preset",
    MULTI_PRESET_UPDATE_NO_MATCH_NOTICE: "Could not resolve the link!",
