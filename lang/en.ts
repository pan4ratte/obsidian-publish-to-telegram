...
4. "Bot + rich-text" doesn't require Telegram Premium, but can't attach local files.`,
    ...
    MULTI_PRESET_LINK_PREVIEW_NAME: "Link preview",
    MULTI_PRESET_LINK_PREVIEW_DESC: "Where Telegram renders the webpage preview",
    MULTI_PRESET_LINK_PREVIEW_OPT_DEFAULT: "Default",
    MULTI_PRESET_LINK_PREVIEW_OPT_TOP: "Above the text",
    MULTI_PRESET_LINK_PREVIEW_OPT_OFF: "Disabled",
    ...
    MULTI_PRESET_SPLIT_NONE_SELECTED: "Select at least one post to publish",
