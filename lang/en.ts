...
4. "Bot + rich-text" doesn't require Telegram Premium, but can't attach local files.`,
    ...
    MULTI_PRESET_SPLIT_MODE_NO_LINK: "Не выбрана цель редактирования: выбрите, какую какую публикацию нужно изменить. Edit target is not chosen: select, which published post to update.",
