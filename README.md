...
<div align="center">
<br>
 <picture><source media="(prefers-color-scheme: light)" srcset="https://www.shieldcn.dev/github/release/pan4ratte/obsidian-publish-to-telegram.svg?size=sm&amp;mode=dark&amp;variant=outline"><img alt="Release" src="https://www.shieldcn.dev/github/release/pan4ratte/obsidian-publish-to-telegram.svg?size=sm&amp;mode=light&amp;variant=outline"></picture> <a href="https://github.com/pan4ratte/obsidian-publish-to-telegram/releases"><picture><source media="(prefers-color-scheme: light)" srcset="https://shieldcn.dev/github/pan4ratte/obsidian-publish-to-telegram/downloads.svg?variant=outline&amp;mode=dark"><img alt="badge" src="https://shieldcn.dev/github/pan4ratte/obsidian-publish-to-telegram/downloads.svg?variant=outline&amp;mode=light"></picture></a> <a href="https://mtcute.dev/"><picture><source media="(prefers-color-scheme: light)" srcset="https://shieldcn.dev/badge/built%20on-mtcute.svg?variant=outline&amp;logo=data%3Aimage%2Fsvg%2Bxml%2C%3Csvg+xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27+viewBox%3D%270+0+24+24%27%3E%3Cpath+fill%3D%27%2523de6fbe%27+d%3D%27M18+1.6a3.6+3.6+0+0+1+1.3+5l-1+1.8h2.1a3.6+3.6+0+0+1+0+7.2h-2.2l1.1+1.9a3.6+3.6+0+1+1-6.2+3.6L4.7+6.5A3.6+3.6+0+0+1+10.9+3L12+4.8l1-1.9a3.6+3.6+0+0+1+5-1.3%27%2F%3E%3Cpath+fill%3D%27%2523f69ddc%27+d%3D%27M15.1+13.8a3.6+3.6+0+0+0-3.3-5.4H3.6a3.6+3.6+0+0+0+0+7.2h2.2l-1.1+1.9a3.6+3.6+0+0+0+6.2+3.6z%27%2F%3E%3C%2Fsvg%3E&amp;logoColor=de6fbe&amp;mode=dark"><img alt="badge" src="https://shieldcn.dev/badge/built%20on-mtcute.svg?variant=outline&amp;logo=data%3Aimage%2Fsvg%2Bxml%2C%3Csvg+xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27+viewBox%3D%270+0+24+24%27%3E%3Cpath+fill%3D%27%2523de6fbe%27+d%3D%27M18+1.6a3.6+3.6+0+0+1+1.3+5l-1+1.8h2.1a3.6+3.6+0+0+1+0+7.2h-2.2l1.1+1.9a3.6+3.6+0+1+1-6.2+3.6L4.7+6.5A3.6+3.6+0+0+1+10.9+3L12+4.8l1-1.9a3.6+3.6+0+0+1+5-1.3%27%2F%3E%3Cpath+fill%3D%27%2523f69ddc%27+d%3D%27M15.1+13.8a3.6+3.6+0+0+0-3.3-5.4H3.6a3.6+3.6+0+0+0+0+7.2h2.2l-1.1+1.9a3.6+3.6+0+0+0+6.2+3.6z%27%2F%3E%3C%2Fsvg%3E&amp;logoColor=de6fbe&amp;mode=light"></picture></a>
</div>
